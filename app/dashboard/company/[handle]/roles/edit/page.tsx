// app/dashboard/company/[handle]/roles/[roleId]/edit/page.tsx
...
export default async function EditRolePage({ 
  ...
  params: { handle: string; roleId: string } 
}) {
  ...
  return (
    <CompanyLayout handle={handle} currentPath={currentPath}>
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-[#4b0076]">Edit Role</h1>
          <p className="text-muted-foreground">
            {role.is_default 
              ? "This is a default role. You can modify its permissions but not its name or position."
              : `Edit role settings and permissions for "${role.name}"`
            }
          </p>
        </div>
