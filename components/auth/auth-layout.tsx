  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <header className="w-full py-4 px-6 flex justify-between items-center bg-white/80 backdrop-blur-sm shadow-sm z-10">
        ...
        <div className="flex gap-3">
          <Link 
            ...
            className="px-4 py-2 rounded-md border border-primary/30 text-primary hover:bg-primary/5 transition-colors"
          >
            {oppositeLabel}
          </Link>
        </div>
      ...
      <main className="flex-1 flex items-center justify-center p-6 relative">
        {/* Decorative elements */}
        <motion.div 
          className="absolute top-20 left-20 h-16 w-16 rounded-full bg-primary/10 backdrop-blur-md border border-primary/20 hidden lg:block"
          animate={{ 
            y: [0, 15, 0], 
          }} 
          transition={{ 
        ...
        <motion.div 
          className="absolute bottom-20 right-20 h-24 w-24 rounded-full bg-accent/10 backdrop-blur-md border border-accent/20 hidden lg:block"
          animate={{ 
            y: [0, -20, 0], 
          }} 
          transition={{ 
